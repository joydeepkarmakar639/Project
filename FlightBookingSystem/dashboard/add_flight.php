...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="index3.html" class="brand-link" hidden>
    ...
    <div class="content-wrapper">
      ...
      <form action="save_flight.php" method="post">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="fno" id="fno" placeholder="Flight Number" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" name="stops" id="stops" min="0" max="50"
            placeholder="Number of Stops" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="time" class="form-control" name="time" id="time" placeholder="Time of Flight" required>
        </div>

        <div class="mb-3">
          <label for="fare" class="form-label">Flight Fare(in Rs.)</label>
          <input type="number" class="form-control" name="fare" id="fare" placeholder="Fare of Flight" min="0" required>
        </div>
